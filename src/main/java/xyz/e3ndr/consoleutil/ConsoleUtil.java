...
public class ConsoleUtil {
	...
	static {
		if (platform == JavaPlatform.UNKNOWN) {
			...
			logger.warn("Please report the system type \"%s\" to the developers (Make an issue report).",
	 ...
	 * @throws IOException Signals that an I/O exception has occurred during the
